...
namespace Command_parsing
{
    public static class Parser_creator
    {
        ...
        public static void Create_1_13()
        {
            ...
            parser.Add_replace_validator("entity", new Selector_validator(false, false, false));

            parser.Add_replace_validator("item", new Item_validator(false));
            parser.Add_replace_validator("item_tag", new Item_tag_validator(false));
            parser.Add_replace_validator("block_data", new Block_validator());
            parser.Add_replace_validator("block_data_tag", new Block_data_tag_validator());

            parser.Add_replace_validator("nbt", new Nbt_validator());
            parser.Add_replace_validator("entity_nbt", new Entity_nbt_validator());
            parser.Add_replace_validator("nbt_path", new Nbt_path_validator());

            parser.Add_replace_validator("particle", new Particle_validator(false));

            parser.Add_replace_validator("scoreboard_criteria", new Scoreboard_criteria_validator());

            parser.Add_replace_validator("function_call", new Function_call_validator());
            ...
            parser.Add_command(new Command_model(new Command_name("scoreboard"), new Command_choice(new Command_choice_part("objectives", new Command_choice(new Command_choice_part("add", new Command_text(), new Command_text("scoreboard_criteria"), new Command_str_text(true)), new Command_choice_part("list"), new Command_choice_part("modify", new Command_text(), new Command_choice(new Command_choice_part("displayname", new Command_str_text()), new Command_choice_part("rendertype", new Command_choice(new string[] { "hearts", "integer" })))), new Command_choice_part("remove", new Command_text()), new Command_choice_part("setdisplay", new Command_text("SCOREBOARD_DISPLAY"), new Command_text()))), new Command_choice_part("players", new Command_choice(new Command_choice_part("add", new Command_entity(), new Command_text(), new Command_int()), new Command_choice_part("enable", new Command_entity(), new Command_text()), new Command_choice_part("get", new Command_entity(), new Command_text()), new Command_choice_part("list", new Command_entity()), new Command_choice_part("operation", new Command_entity(), new Command_text(), new Command_choice(new string[] { "%=", "*=", "+=", "-=", "/=", "<", "=", ">", "><" }), new Command_entity(), new Command_text()), new Command_choice_part("remove", new Command_entity(), new Command_text(), new Command_int()), new Command_choice_part("reset", new Command_entity(), new Command_text()), new Command_choice_part("set", new Command_entity(), new Command_text(), new Command_int()))))));
            ...
            parser.Add_command(new Command_model(new Command_name("team"), new Command_choice(new Command_choice_part("add", new Command_text(), new Command_str_text(true, true)), new Command_choice_part("empty", new Command_text()), new Command_choice_part("join", new Command_text(), new Command_entity()), new Command_choice_part("leave", new Command_entity()), new Command_choice_part("list", new Command_text()), new Command_choice_part("modify", new Command_text(), new Command_choice(new Command_choice_part("collisionRule", new Command_bool()), new Command_choice_part("color", new Command_text("TEAM_COLOR")), new Command_choice_part("deathMessageVisibility", new Command_bool()), new Command_choice_part("displayName", new Command_str_text(false, true)), new Command_choice_part("friendlyFire", new Command_bool()), new Command_choice_part("nametagVisible", new Command_bool()), new Command_choice_part("prefix", new Command_str_text(false, true)), new Command_choice_part("seeFriendlyInvisibles", new Command_bool()), new Command_choice_part("suffix", new Command_str_text(false, true)))), new Command_choice_part("remove", new Command_text()))));
            ...
            parser.Add_command(new Command_model(new Command_name("tellraw"), new Command_entity(false, false, Entity_type_limitation.Only_player), new Command_str_text(false, true)));
            ...
            parser.Add_command(new Command_model(new Command_name("title"), new Command_entity(false, false, Entity_type_limitation.Only_player), new Command_choice(new Command_choice_part("actionbar", new Command_str_text(false, true)), new Command_choice_part("clear"), new Command_choice_part("reset"), new Command_choice_part("subtitle", new Command_str_text(false, true)), new Command_choice_part("times", new Command_int(), new Command_int(), new Command_int()), new Command_choice_part("title", new Command_str_text(false, true)))));
        ...
        public static void Create_1_14()
        {
            ...
            parser.Add_replace_validator("entity", new Selector_validator(true, false, false));
            parser.Set_validator_severity("LOOT_TABLE", Problem_severity.Warning);
        ...
        public static void Create_1_15()
        {
            ...
            parser.Add_replace_validator("entity", new Selector_validator(true, true, false));
            ...
            parser.Add_replace_command(new Command_model(new Command_name("schedule"), new Command_choice(new Command_choice_part("function", new Command_text("function_call"), new Command_time(), new Command_choice(new string[] { "append", "replace" }, true)), new Command_choice_part("clear", new Command_text("function_call", false, true)))));
        ...
        public static void Create_1_16()
        {
            ...
            parser.Add_command(new Command_model(new Command_name("attribute"), new Command_entity(false, true), new Command_text("ATTRIBUTE"), new Command_choice(new Command_choice_part("get", new Command_float(true)), new Command_choice_part("base", new Command_choice(new Command_choice_part("get", new Command_float(true)), new Command_choice_part("set", new Command_float()))), new Command_choice_part("modifier", new Command_choice(new Command_choice_part("add", new Command_uuid(), new Command_str_text(), new Command_float(), new Command_choice(new string[] { "add", "multiply", "multiply_base" })), new Command_choice_part("remove", new Command_uuid()), new Command_choice_part("value", new Command_choice(new Command_choice_part("get", new Command_uuid(), new Command_float(true)))))))));
        ...
        public static void Create_1_16_2()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("spawnpoint"), new Command_entity(true, false, Entity_type_limitation.Only_player), new Command_pos(true), new Command_float(true)));
        ...
        public static void Create_1_17()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("debug", 3), new Command_choice(new Command_choice_part("start"), new Command_choice_part("stop"), new Command_choice_part("function", new Command_text("function_call",false,true)))));
        ...
        public static void Create_1_19()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("locate"), new Command_choice(new Command_choice_part("biome", new Command_text("BIOME_TAG")), new Command_choice_part("poi", new Command_text("POI_TAG")), new Command_choice_part("structure", new Command_text("STRUCTURE_TAG")))));
        ...
        public static void Create_1_19_3()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("publish", 4), new Command_bool(true), new Command_choice(new string[] { "adventure", "creative", "spectator", "survival" }), new Command_int(65535, true)));
        ...
        public static void Create_1_19_4()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("weather"), new Command_choice(new string[] { "clear", "rain", "thunder" }), new Command_time(true)));
            parser.Add_replace_command(new Command_model(new Command_name("title"), new Command_entity(false, false, Entity_type_limitation.Only_player), new Command_choice(new Command_choice_part("actionbar", new Command_str_text(false, true)), new Command_choice_part("clear"), new Command_choice_part("reset"), new Command_choice_part("subtitle", new Command_str_text(false, true)), new Command_choice_part("times", new Command_time(), new Command_int(), new Command_int()), new Command_choice_part("title", new Command_str_text(false, true)))));
        ...
        public static void Create_1_20_2()
        {
            ...
            //TODO int range
            parser.Add_command(new Command_model(new Command_name("random"), new Command_choice(new Command_choice_part("reset", new Command_text(/*"RANDOM"*/), new Command_int(true), new Command_bool(true), new Command_bool(true)), new Command_choice_part("value", new Command_text(/*"RANDOM",*/true)), new Command_choice_part("roll", new Command_text(/*"RANDOM",*/ true)))));
        ...
        public static void Create_1_20_3()
        {
            ...
            parser.Add_replace_command(Command_model_builder.Get_execute(Versions.Get_own_version(version)));
            parser.Add_replace_command(new Command_model(new Command_name("return"), new Command_choice(new Command_choice_part(new Command_int()), new Command_choice_part("fail"), new Command_choice_part(new Command_execute_stop(false, true)))));
            parser.Add_replace_command(new Command_model(new Command_name("scoreboard"), new Command_choice(new Command_choice_part("objectives", new Command_choice(new Command_choice_part("add", new Command_text(), new Command_text("scoreboard_criteria"), new Command_str_text(true, true)), new Command_choice_part("list"), new Command_choice_part("modify", new Command_text(), new Command_choice(new Command_choice_part("numberformat", new Command_choice(new Command_choice_part("blank"), new Command_choice_part("fixed", new Command_text()), new Command_choice_part("styled", new Command_text()))), new Command_choice_part("displayautoupdate", new Command_bool()), new Command_choice_part("displayname", new Command_str_text()), new Command_choice_part("rendertype", new Command_choice(new string[] { "hearts", "integer" })))), new Command_choice_part("remove", new Command_text()), new Command_choice_part("setdisplay", new Command_text("SCOREBOARD_DISPLAY"), new Command_text()))), new Command_choice_part("players", new Command_choice(new Command_choice_part("display", new Command_choice(new Command_choice_part("name", new Command_entity(), new Command_text(), new Command_str_text(false, true)), new Command_choice_part("numberformat", new Command_entity(), new Command_text(), new Command_choice(new Command_choice_part("blank"), new Command_choice_part("fixed", new Command_text()), new Command_choice_part("styled", new Command_text()))))), new Command_choice_part("add", new Command_entity(), new Command_text(), new Command_int()), new Command_choice_part("enable", new Command_entity(), new Command_text()), new Command_choice_part("get", new Command_entity(), new Command_text()), new Command_choice_part("list", new Command_entity()), new Command_choice_part("operation", new Command_entity(), new Command_text(), new Command_choice(new string[] { "%=", "*=", "+=", "-=", "/=", "<", "=", ">", "><" }), new Command_entity(), new Command_text()), new Command_choice_part("remove", new Command_entity(), new Command_text(), new Command_int()), new Command_choice_part("reset", new Command_entity(), new Command_text()), new Command_choice_part("set", new Command_entity(), new Command_text(), new Command_int()))))));
        ...
        public static void Create_1_20_5()
        {
            ...
            //TODO new particle validator: minecraft:dust{color:[0.3254,0.9804,0.9804], scale:1}
            ...
            parser.Add_replace_validator("item", new Item_validator(true));
            parser.Add_replace_validator("item_tag", new Item_tag_validator(true));

            parser.Add_replace_validator("particle", new Particle_validator(true));
            ...
            parser.Add_replace_command(Command_model_builder.Get_execute(Versions.Get_own_version(version)));
            parser.Add_replace_command(new Command_model(new Command_name("attribute"), new Command_entity(false, true), new Command_text("ATTRIBUTE"), new Command_choice(new Command_choice_part("get", new Command_float(true)), new Command_choice_part("base", new Command_choice(new Command_choice_part("get", new Command_float(true)), new Command_choice_part("set", new Command_float()))), new Command_choice_part("modifier", new Command_choice(new Command_choice_part("add", new Command_uuid(), new Command_str_text(), new Command_float(), new Command_choice(new string[] { "add_value", "add_multiplied_base", "add_multiplied_total" })), new Command_choice_part("remove", new Command_uuid()), new Command_choice_part("value", new Command_choice(new Command_choice_part("get", new Command_uuid(), new Command_float(true)))))))));
        ...
        public static void Create_1_21()
        {
            ...
            parser.Add_replace_validator("entity", new Selector_validator(true, true, true));
        ...
        //TODO removal of str text for text with a validator this validator will be changable
        public static void Create_1_21_5()
        {
            ...
            parser.Add_replace_command(new Command_model(new Command_name("setblock"), new Command_pos(), new Command_text("block_data"), new Command_choice(new string[] { "replace", "keep", "destroy","strict" }, true)));
        ...
        private static void Tree_add(Command_parser parser, string version)
        {
            ...
            //List<string> item_hand = parser.Get_collection("ITEM");
